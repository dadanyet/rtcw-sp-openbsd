...
void _UI_Refresh( int realtime ) {
	...
	if ( Menu_Count() > 0 ) {
		...
		//	UI_DrawHandlePic( uiInfo.uiDC.cursorx - 16, uiInfo.uiDC.cursory - 16, 32, 32, uiInfo.uiDC.Assets.cursor, ALIGN_STRETCH );
			...
			int		x, y, w, h;
			x = uiInfo.uiDC.cursorx - (16 * uiInfo.uiDC.avgscale);
			y = uiInfo.uiDC.cursory - (16 * uiInfo.uiDC.avgscale);
			w = h = 32 * uiInfo.uiDC.avgscale;
...
void _UI_Init( qboolean inGameLoad ) {
	...
	uiInfo.uiDC.avgscale = min(uiInfo.uiDC.xscale, uiInfo.uiDC.yscale);	// Knightmare added
